...
// 🔄 REVISED: Imported useEffect
import { useState, useEffect } from "react";
// 🚀 NEW: Import the Solana wallet hook
...
export default function CreateEventEnhanced() {
  // 🚀 NEW: Get the connected wallet accounts
  ...
  // 🔄 REVISED: Initialize state with the fetched wallet address
  ...
  // 🚀 NEW: Effect to update the wallet address if it changes after component loads
  useEffect(() => {
    if (accounts?.[0]) {
